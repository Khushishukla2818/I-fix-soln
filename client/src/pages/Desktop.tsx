  ...
  return (
    <div className="bg-white w-full relative">
      ...
      <a
        ...
        className="hidden md:block fixed bottom-80 right-0 z-40 shadow-[-7px_2px_4px_#00000040] transition-transform hover:-translate-x-1"
      >
      ...
      <div className="hidden md:flex fixed bottom-12 right-4 md:right-[23px] flex-col gap-6 md:gap-[26px]">
        <a
